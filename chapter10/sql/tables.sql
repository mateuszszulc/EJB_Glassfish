...
insert into categories values (1000, 'Junk Cars from Dumpster', sysdate, 'viper', null)
/
insert into categories values (1001, 'House Hold Junks', sysdate, 'viper', null)
/
insert into categories values (1003, 'Outdated Garments', sysdate, 'viper', null)
/
insert into categories values (1004, 'Outdated Furniture', sysdate, 'viper', null)
/
insert into items values (1, 100.50, 'Vintage Car', sysdate, sysdate+10, sysdate, 'junkseller')
/
insert into items values (2, 200.50, 'Cars junked', sysdate, sysdate+10, sysdate, 'junkseller')
/
insert into items values (3, 120.50, 'Bell Bottom Pants', sysdate, sysdate+10, sysdate, 'junkseller')
/
insert into categories_items values (1000, 1)
/
insert into categories_items values (1000, 2)
/
insert into categories_items values (1003, 3)
/
commit
/